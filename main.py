...
def main_menu():
    while True:
        ...
        if choice == '1':
            ...
            print(f"Le mot le plus répété par Chirac est : '{word}' avec {count} occurrences.")
        elif choice == '4':
            ...
            print(f"Président l'ayant le plus mentionné : {president_le_plus_mentionne} ({mentions_nation[president_le_plus_mentionne]} fois)")
        elif choice == '5':
